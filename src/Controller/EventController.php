...
class EventController extends AbstractController implements TokenAuthenticatedController
{
    ...
    public function index(EntityManagerInterface $em)
    {
        ...
        $data = [];
        foreach ($events as $e) array_push($data, JS::getEvent($e));
    ...
    public function create(Request $req, EntityManagerInterface $em)
    {
        ...
        $em->persist($p);
        $em->flush();
        return new JR(JS::getEvent($p), Response::HTTP_CREATED);
    }
    ...
    public function show(EntityManagerInterface $em, $id)
    {
        ...
        return new JR(JS::getEvent($e), Response::HTTP_OK);
    }
    ...
    public function participate(Request $req, EntityManagerInterface $em)
    {
        ...
        if (!$event || !$user) return new JR(null, Response::HTTP_NOT_FOUND);
